...
public partial class BankContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Account__3214EC27FD2F627B");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__AccountT__3214EC27848D1DE5");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Administ__3214EC274201DB38");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__BankTran__3214EC279F102D30");
            ...
            entity.HasOne(d => d.Account).WithMany(p => p.BankTransactions)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__BankTrans__Accou__4AB81AF0");

            entity.HasOne(d => d.TransactionTypeNavigation).WithMany(p => p.BankTransactions)
                .HasForeignKey(d => d.TransactionType)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__BankTrans__Trans__4BAC3F29");
        });

        modelBuilder.Entity<Client>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Client__3214EC2764B6F9B8");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Transact__3214EC279B2EFCFE");
